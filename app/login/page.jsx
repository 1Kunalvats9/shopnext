    ...
    try {
      ...
      if (res.ok) {
        try {
          ...
          console.error('Login succeeded (status ok) but failed to parse JSON response:', responseText, parseError);
          throw new Error('Received an invalid successful response from the server.');
        }
      } else {
